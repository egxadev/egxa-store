...
export default function ProductShow() {
    ...
    const [colorImage, setColorImage] = useState(
        product.product_images[0].color.image
    );
    ...
    return (
        <>
            <Head>
                <title>{`${product.title} - Egxa Store - Where Developer Shopping`}</title>
            </Head>
            <LayoutWeb>
                                                ...
                                                {product.product_images.map(
                                                    (color, index) => (
                                                        <button
                                                            ...
                                                            key={index}
                                                            className="btn btn-transparent btn-sm me-2 border-0 text-center"
                                                        >
                                                            <img
                                                                src={
                                                                    color.color
                                                ...
                                                {product.product_sizes.map(
                                                    (size, index) => (
                                                        <button
                                                            ...
                                                            className="btn btn-success btn-sm me-2 border-0 shadow-sm w-5"
                                                            key={index}
                                                        >
                                                            {size.size}
                                                        </button>
