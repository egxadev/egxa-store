import { r as rt, R as S, u as ao, H as ro } from "./app.4f71476c.js";
import { L as lo, h as Wi } from "./Account.6793dd1a.js";
/*!
 * Chart.js v3.9.1
...
function an(i, t) {
    ...
    return o < -0.5 * N && (o += I), { angle: o, distance: n };
}
function li(i, t) {
...
const Dt = (i, t, e, s) =>
        wi(i, e, s ? (n) => i[n][t] <= e : (n) => i[n][t] < e),
    Mo = (i, t, e) => wi(i, e, (s) => i[s][t] >= e);
function ko(i, t, e) {
    let s = 0,
        n = i.length;
    for (; s < n && i[s] < t; ) s++;
...
const rn = ["push", "pop", "shift", "splice", "unshift"];
function So(i, t) {
    if (i._chartjs) {
    ...
    if (i._sorted) {
        ...
        d &&
            (n = U(
                Math.min(
                    Dt(r, a.axis, c).lo,
                    e ? s : Dt(t, l, a.getPixelForValue(c)).lo
                ),
                0,
                s - 1
            )),
            u
                ? (o =
                      U(
                          Math.max(
                              Dt(r, a.axis, h, !0).hi + 1,
                              e ? 0 : Dt(t, l, a.getPixelForValue(h), !0).hi + 1
                          ),
                          n,
                          s
                      ) - n)
...
const fe = (i) => i === 0 || i === 1,
    ...
    qi = (i, t, e) => Math.pow(2, -10 * i) * Math.sin(((i - t) * I) / e) + 1,
    Qt = {
        linear: (i) => i,
        easeInQuad: (i) => i * i,
        easeOutQuad: (i) => -i * (i - 2),
        ...
        easeOutElastic: (i) => (fe(i) ? i : qi(i, 0.075, 0.3)),
        easeInOutElastic(i) {
            return fe(i)
                ? i
                : i < 0.5
                ? 0.5 * Ki(i * 2, 0.1125, 0.45)
                : 0.5 + 0.5 * qi(i * 2 - 1, 0.1125, 0.45);
        },
        easeInBack(i) {
...
function qt(i) {
    return mt(re(i * 2.55), 0, 255);
}
function xt(i) {
    return mt(re(i * 255), 0, 255);
}
function ft(i) {
    return mt(re(i / 2.55) / 100, 0, 1);
}
function Gi(i) {
    return mt(re(i * 100), 0, 100);
}
const J = {
        0: 0,
        1: 1,
    ...
    ci = [..."0123456789ABCDEF"],
    Do = (i) => ci[i & 15],
    Oo = (i) => ci[(i & 240) >> 4] + ci[i & 15],
    ge = (i) => (i & 240) >> 4 === (i & 15),
    Ao = (i) => ge(i.r) && ge(i.g) && ge(i.b) && ge(i.a);
function Eo(i) {
    var t = i.length,
        e;
    return (
...
function Xo(i) {
    ...
    if (!!t) {
        if (t[7] !== s) {
            const a = +t[7];
            e = t[8] ? qt(a) : mt(a * 255, 0, 255);
        }
        return (
            (s = +t[1]),
            (n = +t[3]),
            (o = +t[5]),
            (s = 255 & (t[2] ? qt(s) : mt(s, 0, 255))),
            (n = 255 & (t[4] ? qt(n) : mt(n, 0, 255))),
            (o = 255 & (t[6] ? qt(o) : mt(o, 0, 255))),
            { r: s, g: n, b: o, a: e }
        );
    }
}
...
const qe = (i) =>
    ...
    It = (i) => (i <= 0.04045 ? i / 12.92 : Math.pow((i + 0.055) / 1.055, 2.4));
function Ko(i, t, e) {
    const s = It(ft(i.r)),
        n = It(ft(i.g)),
        o = It(ft(i.b));
    return {
        r: xt(qe(s + e * (It(ft(t.r)) - s))),
        g: xt(qe(n + e * (It(ft(t.g)) - n))),
        b: xt(qe(o + e * (It(ft(t.b)) - o))),
        a: i.a + e * (t.a - i.a),
    };
}
function me(i, t, e) {
...
function Qi(i) {
    ...
    return (
        Array.isArray(i)
            ...
            : ((t = pn(i, { r: 0, g: 0, b: 0, a: 1 })), (t.a = xt(t.a))),
        t
    );
}
function qo(i) {
    return i.charAt(0) === "r" ? Xo(i) : Vo(i);
}
class Oe {
    constructor(t) {
...
function Ge(i) {
    return bn(i) ? i : mn(i).saturate(0.5).darken(0.1).hexString();
}
...
function Jo(i, t, e, s) {
    ...
    let l, c, h, d, u;
    for (l = 0; l < r; l++)
        if (((d = e[l]), d != null && B(d) !== !0)) a = Ae(i, n, o, a, d);
        else if (B(d))
            for (c = 0, h = d.length; c < h; c++)
                (u = d[c]), u != null && !B(u) && (a = Ae(i, n, o, a, u));
    i.restore();
    const f = o.length / 2;
    if (f > e.length) {
        ...
        switch ((i.beginPath(), d)) {
            ...
            case "rectRounded":
                (c = f * 0.516),
                    ...
                    (a = Math.cos(g + jt) * l),
                    (r = Math.sin(g + jt) * l),
                    i.arc(e - a, s - r, c, g - N, g - V),
                    i.arc(e + r, s - a, c, g - V, g),
                    i.arc(e + a, s + r, c, g, g + V),
                    i.arc(e - r, s + a, c, g + V, g + N),
                    i.closePath();
                break;
            case "rect":
                if (!u) {
...
function oe(i, t) {
    ...
    i.arc(e + a.topLeft, s + a.topLeft, a.topLeft, -V, N, !0),
        i.lineTo(e, s + o - a.bottomLeft),
        i.arc(e + a.bottomLeft, s + o - a.bottomLeft, a.bottomLeft, N, V, !0),
...
const sa = new RegExp(/^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/),
    na = new RegExp(
...
function Y(i, t) {
    ...
    const n = {
        ...
        lineHeight: oa(D(i.lineHeight, t.lineHeight), e),
        size: e,
        style: s,
...
function Di(i, t = [""], e = i, s, n = () => i[0]) {
    it(s) || (s = Mn("_fallback", i));
    const o = {
...
function yn(i, t = { scriptable: !0, indexable: !0 }) {
    const {
...
function ca(i, t, e) {
    ...
    let r = s[t];
    return (
        yt(r) && a.isScriptable(t) && (r = ha(t, r, i, e)),
        B(r) && r.length && (r = da(t, r, i, a.isIndexable)),
        Oi(t, r) && (r = Vt(r, n, o && o[t], a)),
        r
    );
}
function ha(i, t, e, s) {
...
const ua = (i, t) => (i === !0 ? t : typeof i == "string" ? _t(t, i) : void 0);
...
function Ai(i, t, e, s) {
    ...
    return l === null ||
        (it(o) && o !== e && ((l = is(r, a, o, l, s)), l === null))
        ? !1
        : Di(Array.from(r), [""], n, o, () => ga(t, e, s));
}
function is(i, t, e, s, n) {
    for (; e; ) e = fa(i, t, e, s, n);
    return e;
}
function ga(i, t, e) {
    ...
    for (e = 0, s = i.length; e < s; ++e)
        (a = o),
            ...
            o &&
                ((n = i[e]),
                a &&
                    ((n.cp1x = xe(n.cp1x, t.left, t.right)),
                    (n.cp1y = xe(n.cp1y, t.top, t.bottom))),
                r &&
                    ((n.cp2x = xe(n.cp2x, t.left, t.right)),
                    (n.cp2y = xe(n.cp2y, t.top, t.bottom))));
}
...
const Be = (i) => window.getComputedStyle(i, null);
function ka(i, t) {
    return Be(i).getPropertyValue(t);
}
    ...
    if (t === void 0 || e === void 0) {
        ...
        if (!o) (t = i.clientWidth), (e = i.clientHeight);
            ...
            (t = a.width - c.width - l.width),
                ...
                (s = Ee(r.maxWidth, o, "clientWidth")),
                (n = Ee(r.maxHeight, o, "clientHeight"));
        }
    }
...
function Oa(i, t, e, s) {
    const n = Be(i),
        o = At(n, "margin"),
        a = Ee(n.maxWidth, i, "clientWidth") || De,
        r = Ee(n.maxHeight, i, "clientHeight") || De,
        l = Da(i, t, e);
...
function On(i) {
    return i === "angle"
        ? { between: se, compare: vo, normalize: Z }
...
function An(i, t, e) {
    ...
    const { property: s, start: n, end: o } = e,
        ...
        { start: h, end: d, loop: u, style: f } = Ia(i, t, e),
        g = [];
    let p = !1,
        m = null,
        b,
    ...
    const v = () => l(n, y, b) && r(n, y) !== 0,
        ...
        M = () => p || v(),
        w = () => !p || _();
    for (let P = h, k = h; P <= d; ++P)
        (x = t[P % a]),
            !x.skip &&
                ((b = c(x[s])),
                b !== y &&
                    ((p = l(b, n, o)),
                    m === null && M() && (m = r(b, n) === 0 ? P : k),
                    m !== null &&
                        w() &&
                        (g.push(
                            rs({
    ...
    return (
        m !== null &&
            g.push(rs({ start: m, end: d, loop: u, count: a, style: f })),
        g
    );
}
function En(i, t) {
...
function Na(i, t) {
    ...
    if (!n) return [];
    const o = !!i._loop,
        { start: a, end: r } = za(e, n, o, s);
    if (s === !0) return ls(i, [{ start: a, end: r, loop: o }], e, t);
    const l = r < a ? r + n : r,
        c = !!i._fullLoop && a === 0 && r === n - 1;
    return ls(i, Ba(e, a, l, c), e, t);
}
function ls(i, t, e, s) {
...
class $a {
    constructor(t, e, s, n) {
        ...
        const a = be([t.from, o, n]);
        (this._active = !0),
            (this._fn = t.fn || ja[t.type || typeof a]),
    ...
    update(t, e, s) {
        if (this._active) {
            ...
            (this._start = s),
                ...
                (this._total += o),
                (this._loop = !!t.loop),
                (this._to = be([t.to, e, n, t.from])),
                (this._from = be([t.from, n, e]));
        }
    }
    cancel() {
        this._active &&
...
const Ua = Object.keys(E.animation);
...
class Tn {
    ...
    configure(t) {
        ...
        Object.getOwnPropertyNames(t).forEach((s) => {
            ...
            ((B(n.properties) && n.properties) || [s]).forEach((a) => {
...
function ps(i, t) {
    ...
    for (let f = 0; f < d; ++f) {
        ...
        (u = b[c] = er(n, h, p)),
            (u[r] = m),
            (u._top = gs(u, a, !0, s.type)),
            (u._bottom = gs(u, a, !1, s.type));
    }
}
function Qe(i, t) {
    const e = i.scales;
...
const ti = (i) => i === "reset" || i === "none",
    ...
    nr = (i, t, e) =>
        i && !t.hidden && t._stacked && { keys: Ln(e, !0), values: null };
class nt {
    constructor(t, e) {
        (this.chart = t),
            (this._ctx = t.ctx),
    ...
    linkScales() {
        const t = this.chart,
            ...
            o = (e.xAxisID = D(s.xAxisID, Qe(t, "x"))),
            a = (e.yAxisID = D(s.yAxisID, Qe(t, "y"))),
            r = (e.rAxisID = D(s.rAxisID, Qe(t, "r"))),
            l = e.indexAxis,
    ...
    _destroy() {
        const t = this._cachedMeta;
        this._data && Ui(this._data, this), t._stacked && $t(t);
    }
    _dataCheck() {
        const t = this.getDataset(),
            e = t.data || (t.data = []),
            s = this._data;
        if (O(e)) this._data = Ja(e);
        else if (s !== e) {
            if (s) {
                Ui(s, this);
            ...
            e && Object.isExtensible(e) && So(e, this),
                (this._syncList = []),
                (this._data = e);
        }
    }
    ...
    buildOrUpdateElements(t) {
        ...
        this._dataCheck();
        const o = e._stacked;
        (e._stacked = fs(e.vScale, e)),
            e.stack !== s.stack && ((n = !0), $t(e), (e.stack = s.stack)),
    ...
    applyStack(t, e, s) {
        const n = this.chart,
            o = this._cachedMeta,
            a = e[t.axis],
            r = { keys: Ln(n, !0), values: e._stacks[t.axis] };
        return us(r, a, o.index, { mode: s });
    }
    updateRangeFromParsed(t, e, s, n) {
        const o = s[e.axis];
        let a = o === null ? NaN : o;
        const r = n && s._stacks[e.axis];
        n && r && ((n.values = r), (a = us(n, o, this._cachedMeta.index))),
    ...
    _resolveElementOptions(t, e = "default", s) {
        ...
        const c = this.chart.config,
            ...
            f = Object.keys(E.elements[t]),
            g = () => this.getContext(s, n),
            p = c.resolveNamedOptions(u, f, g, d);
        return (
            p.$shared && ((p.$shared = l), (o[a] = Object.freeze(ms(p, l)))), p
        );
    }
...
function ar(i) {
    ...
    const l = () => {
        a === 32767 ||
            a === -32768 ||
            (it(r) && (s = Math.min(s, Math.abs(a - r) || s)), (r = a));
    };
...
function Rn(i, t, e, s) {
    return B(i) ? cr(i, t, e, s) : (t[e.axis] = e.parse(i, s)), t;
}
function bs(i, t, e, s) {
    const n = i.iScale,
        o = i.vScale,
...
function xs(i, t, e, s) {
    return s ? ((i = fr(i, t, e)), (i = _s(i, e, t))) : (i = _s(i, t, e)), i;
}
function fr(i, t, e) {
...
class Ti extends nt {
    ...
    _calculateBarValuePixels(t) {
        ...
        if (m === e.getPixelForValue(a)) {
            const b = (ct(g) * e.getLineWidthForValue(a)) / 2;
            (m += b), (g -= b);
        }
...
function pr(i, t, e) {
    ...
    if (t < I) {
        const r = i,
            ...
            u = Math.sin(l),
            f = (y, v, _) =>
                se(y, r, l, !0) ? 1 : Math.max(v, v * e, _, _ * e),
            g = (y, v, _) =>
                se(y, r, l, !0) ? -1 : Math.min(v, v * e, _, _ * e),
            p = f(0, c, d),
            m = f(V, h, u),
            b = g(N, c, d),
            x = g(N + V, h, u);
    ...
    updateElements(t, e, s, n) {
        ...
        for (x = e; x < e + s; ++x) {
            ...
            m &&
                (_.options =
                    p ||
                    this.resolveDataElementOptions(x, v.active ? "active" : n)),
                (b += y),
    ...
    updateElements(t, e, s, n) {
        ...
        for (let y = e; y < e + s; ++y) {
            const v = t[y],
                ...
                M = b ? v : {},
                w = R(_[f]),
                P = (M[u] = a.getPixelForValue(_[u], y)),
                k = (M[f] =
                    o || w
                        ? r.getBasePixel()
                        : r.getPixelForValue(
                              l ? this.applyStack(r, _, l) : _[f],
                              y
                          ));
            (M.skip = isNaN(P) || isNaN(k) || w),
                (M.stop = y > 0 && Math.abs(_[u] - x[u]) > m),
                p && ((M.parsed = _), (M.raw = c.data[y])),
                d &&
                    (M.options =
                        h ||
                        this.resolveDataElementOptions(
...
class Ri extends nt {
    ...
    updateElements(t, e, s, n) {
        ...
        for (g = e; g < e + s; g++) {
            ...
            (f = x),
                o &&
                    (l.animateScale && (y = 0), l.animateRotate && (b = x = u));
            const v = {
                x: h,
                y: d,
                innerRadius: 0,
...
function br(i, t) {
    ...
    if (o > 0) {
        ...
        for (_e(t, l, c, R(u) ? 0 : a - u, a), h = 0, d = o - 1; h < d; h++)
            _e(t, l, c, n[h], n[h + 1]);
        return _e(t, l, c, r, R(u) ? t.length : r + u), l;
    }
    return _e(t, l, c), l;
}
function xr(i) {
...
const Mr = (i) => (i === "left" ? "right" : i === "right" ? "left" : i),
    ys = (i, t, e) => (t === "top" || t === "left" ? i[t] + e : i[t] - e);
function vs(i, t) {
    const e = [],
        s = i.length / t,
        n = i.length;
...
class Lt extends ot {
    ...
    getUserBounds() {
        ...
        return (
            ...
            { min: Q(t, s), max: Q(e, n), minDefined: H(t), maxDefined: H(e) }
        );
    }
    getMinMax(t) {
        let {
    ...
    update(t, e, s) {
        ...
        this._convertTicksToLabels(l ? vs(this.ticks, r) : this.ticks),
            this.configure(),
    ...
    fit() {
        ...
        if (a) {
            ...
            if (
                (r
                    ? ((t.width = this.maxWidth), (t.height = Yt(o) + l))
                    : ((t.height = this.maxHeight), (t.width = Yt(o) + l)),
    ...
    _computeLabelSizes(t, e) {
        ...
        for (c = 0; c < e; ++c) {
            if (
                ...
                (b = Ae(s, p.data, p.gc, b, u)), (x = m);
            else if (B(u))
                for (h = 0, d = u.length; h < d; ++h)
                    (y = u[h]),
                        !R(y) &&
                            !B(y) &&
                            ((b = Ae(s, p.data, p.gc, b, y)), (x += m));
    ...
    getPixelForDecimal(t) {
        ...
        return wo(this._alignToPixels ? kt(this.chart, e, 0) : e);
    }
    ...
    _computeGridLineItems(t) {
        ...
        if (a === "top")
            ...
            (T = t.top), (A = t.bottom), (M = b + p), (P = M + d);
        } else if (e === "y") {
            ...
            (_ = b - p), (w = _ - d), (k = t.left), (L = t.right);
        }
        const j = D(n.ticks.maxTicksLimit, h),
            q = Math.max(1, Math.ceil(h / j));
        for (x = 0; x < h; x += q) {
            const C = o.setContext(this.getContext(x)),
                $ = C.lineWidth,
                W = C.color,
                Mt = C.borderDash || [],
                Ye = C.borderDashOffset,
                Rt = C.tickWidth,
                ue = C.tickColor,
                Ft = C.tickBorderDash || [],
                Ht = C.tickBorderDashOffset;
            (y = kr(this, x, r)),
                y !== void 0 &&
                    ((v = kt(s, y, $)),
                    l ? (_ = w = k = L = v) : (M = P = T = A = v),
                    u.push({
                        tx1: _,
                        ty1: M,
                        tx2: w,
    ...
    _computeLabelItems(t) {
        ...
        if (n === "top")
            ...
            if (n === "center") M = (t.top + t.bottom) / 2 + f;
                ...
                const C = Object.keys(n)[0],
                    $ = n[C];
                M = this.chart.scales[C].getPixelForValue($) + f;
            }
        ...
        for (b = 0, x = r.length; b < x; ++b) {
            ...
            const $ = L / 2,
                W = C.color,
                Mt = C.textStrokeColor,
                Ye = C.textStrokeWidth;
            let Rt = w;
            a
                ? ((_ = P),
                  w === "inner" &&
                  ...
                  n === "top"
                      ? c === "near" || p !== 0
                          ? (A = -L * T + T / 2)
                          : c === "center"
                          ? (A = -q.highest.height / 2 - $ * T + T)
                          : (A = -q.highest.height + T / 2)
                      : c === "near" || p !== 0
                      ? (A = T / 2)
                      : c === "center"
                      ? (A = q.highest.height / 2 - $ * T)
                      : (A = q.highest.height - L * T),
                  d && (A *= -1))
                : ((M = P), (A = ((1 - L) * T) / 2));
            let ue;
            if (C.showLabelBackdrop) {
                const Ft = K(C.backdropPadding),
                    Ht = q.heights[b],
                    Xe = q.widths[b];
                let Ue = M + A - Ft.top,
                    Ke = _ - Ft.left;
    ...
    drawBorder() {
        ...
        let l, c, h, d;
        this.isHorizontal()
            ? ((l = kt(t, this.left, o) - o / 2),
              (c = kt(t, this.right, a) + a / 2),
              (h = d = r))
            : ((h = kt(t, this.top, o) - o / 2),
...
class ye {
    ...
    unregister(t) {
        const e = this.items,
            ...
            n = this.scope;
        s in e && delete e[s],
            n && s in E[n] && (delete E[n][s], this.override && delete Et[s]);
    }
}
function Ar(i, t, e) {
    ...
    E.set(t, s),
        i.defaultRoutes && Er(t, i.defaultRoutes),
        i.descriptors && E.describe(t, i.descriptors);
}
function Er(i, t) {
...
class Lr {
    constructor() {
        (this.controllers = new ye(nt, "datasets", !0)),
            (this.elements = new ye(ot, "elements")),
            (this.plugins = new ye(Object, "plugins")),
            (this.scales = new ye(Lt, "scales")),
...
class Ii extends nt {
    ...
    addElements() {
        ...
        !this.datasetElementType &&
            t &&
            (this.datasetElementType = lt.getElement("line")),
            super.addElements();
    }
    updateElements(t, e, s, n) {
        const o = n === "reset",
        ...
        for (let v = e; v < e + s; ++v) {
            const _ = t[v],
                ...
                w = x ? _ : {},
                P = R(M[g]),
                k = (w[f] = a.getPixelForValue(M[f], v)),
                T = (w[g] =
                    o || P
                        ? r.getBasePixel()
                        : r.getPixelForValue(
            ...
            (w.skip = isNaN(k) || isNaN(T) || P),
                (w.stop = v > 0 && Math.abs(M[f] - y[f]) > b),
                m && ((w.parsed = M), (w.raw = c.data[v])),
                u &&
                    (w.options =
                        d ||
                        this.resolveDataElementOptions(
...
ui.override = function (i) {
    Object.assign(ui.prototype, i);
};
var Rr = { _date: ui };
function Fr(i, t, e, s) {
    ...
    if (r && t === r.axis && t !== "r" && a && o.length) {
        const l = r._reversePixels ? Mo : Dt;
        if (s) {
            if (n._sharedOptions) {
                const c = o[0],
...
function $r(i, t, e, s) {
    ...
    const r = Math.max(0, t.outerWidth - Ss(a, i, "left", "right")),
        l = Math.max(0, t.outerHeight - Ss(a, i, "top", "bottom")),
        c = r !== i.w,
        h = l !== i.h;
    return (
        (i.w = r),
...
function Ps(i, t, e, s) {
    ...
    for (const r of i) {
        ...
        if (r.horizontal) {
            const d = t.w * h,
                u = c.size || l.height;
            it(c.start) && (a = c.start),
                l.fullSize
                    ? ve(l, n.left, a, e.outerWidth - n.right - n.left, u)
                    : ve(l, t.left + c.placed, a, d, u),
                (c.start = a),
                (c.placed += d),
                (a = l.bottom);
        } else {
            ...
            it(c.start) && (o = c.start),
                l.fullSize
                    ? ve(l, o, n.top, u, e.outerHeight - n.bottom - n.top)
                    : ve(l, o, t.top + c.placed, u, d),
                (c.start = o),
                (c.placed += d),
                (o = l.right);
        }
...
var et = {
    ...
    update(i, t, e, s) {
        ...
        Gt(r.fullSize, f, d, g),
            ...
            Yr(f),
            Ps(r.leftAndTop, f, d, g),
            (f.x += f.w),
            (f.y += f.h),
            Ps(r.rightAndBottom, f, d, g),
            (i.chartArea = {
                left: f.left,
                top: f.top,
                right: f.left + f.w,
...
const Vn = Aa ? { passive: !0 } : !1;
function Gr(i, t, e) {
    i.addEventListener(t, e, Vn);
}
function Zr(i, t, e) {
    i.canvas.removeEventListener(t, e, Vn);
}
function Jr(i, t) {
...
function Qr(i, t, e) {
    const s = i.canvas,
        n = new MutationObserver((o) => {
            let a = !1;
            for (const r of o)
                (a = a || Te(r.addedNodes, s)),
                    (a = a && !Te(r.removedNodes, s));
            a && e();
        });
...
function el(i, t) {
    ae.size || window.addEventListener("resize", Wn), ae.set(i, t);
}
function il(i) {
    ae.delete(i), ae.size || window.removeEventListener("resize", Wn);
}
function sl(i, t, e) {
    const s = i.canvas,
        n = s && Ei(s);
...
class ol extends Nn {
    ...
    removeEventListener(t, e) {
        const s = t.$proxies || (t.$proxies = {}),
            n = s[e];
        if (!n) return;
        (({ attach: ni, detach: ni, resize: ni })[e] || Zr)(t, e, n),
            (s[e] = void 0);
    }
    getDevicePixelRatio() {
...
function hl(i, { plugins: t, localIds: e }, s, n) {
    const o = [],
        a = i.getContext();
    for (const r of t) {
        const l = r.id,
        ...
        c !== null &&
            o.push({
                plugin: r,
                options: dl(i.config, { plugin: r, local: e[l] }, c, a),
            });
    }
    return o;
}
...
function gi(i, t) {
    return i === "x" || i === "y"
        ? i
        : t.axis || gl(t.position) || i.charAt(0).toLowerCase();
}
function pl(i, t) {
    const e = Et[i.type] || { scales: {} },
        s = t.scales || {},
        n = fi(i.type, t),
...
function we(i, t) {
    let e = Os.get(i);
    return e || ((e = t()), Os.set(i, e), $n.add(e)), e;
}
const Kt = (i, t, e) => {
    const s = _t(t, e);
    s !== void 0 && i.add(s);
...
class bl {
    ...
    getOptionScopes(t, e, s) {
        ...
        e.forEach((h) => {
            t && (l.add(t), h.forEach((d) => Kt(l, t, d))),
                ...
                h.forEach((d) => Kt(l, Et[o] || {}, d)),
                h.forEach((d) => Kt(l, E, d)),
                h.forEach((d) => Kt(l, hi, d));
        });
    ...
    chartOptionScopes() {
        ...
        return [t, Et[e] || {}, E.datasets[e] || {}, { type: e }, E, hi];
    }
    resolveNamedOptions(t, e, s, n = [""]) {
        const o = { $shared: !0 },
            { resolver: a, subPrefixes: r } = As(this._resolverCache, t, n);
        let l = a;
        if (_l(a, e)) {
...
const xl = (i) =>
    O(i) && Object.getOwnPropertyNames(i).reduce((t, e) => t || yt(i[e]), !1);
function _l(i, t) {
    const { isScriptable: e, isIndexable: s } = yn(i);
    for (const n of t) {
        const o = e(n),
            a = s(n),
            r = (a || o) && i[n];
        if ((o && (yt(r) || xl(r))) || (a && B(r))) return !0;
    }
    return !1;
}
var yl = "3.9.1";
...
class de {
    constructor(t, e) {
        ...
        if (
            ...
            (this.$context = void 0),
            (this._doResize = Po((d) => this.update(d), a.resizeDelay || 0)),
            (this._dataChanges = []),
            (Le[this.id] = this),
            !r || !l)
        ) {
        ...
        dt.listen(this, "complete", Ls),
            dt.listen(this, "progress", wl),
            this._initialize(),
        ...
        e &&
            ...
            F(o, (a) => {
                const r = a.options,
                    ...
                    h = D(r.type, a.dtype);
                (r.position === void 0 ||
                    Es(r.position, c) !== Es(a.dposition)) &&
            ...
            F(s, (a) => {
                et.configure(this, a, a.options), et.addBox(this, a);
            });
    }
    _updateMetasets() {
    ...
    buildOrUpdateControllers() {
        ...
        for (
            ...
            if (
                ...
                (a.type = r),
                (a.indexAxis = o.indexAxis || fi(r, this.options)),
                (a.order = o.order || 0),
                (a.index = s),
                (a.label = "" + o.label),
    ...
    _checkEventBindings() {
        const t = this.options,
            ...
            s = new Set(t.events);
        (!ji(e, s) || !!this._responsiveListeners !== t.responsive) &&
    ...
    getContext() {
        return (
            this.$context ||
            (this.$context = vt(null, { chart: this, type: "chart" }))
        );
    }
...
const Rs = () => F(de.instances, (i) => i._plugins.invalidate()),
    pt = !0;
Object.defineProperties(de, {
    defaults: { enumerable: pt, value: E },
    instances: { enumerable: pt, value: Le },
    overrides: { enumerable: pt, value: Et },
    registry: { enumerable: pt, value: lt },
    version: { enumerable: pt, value: yl },
    getChart: { enumerable: pt, value: Xn },
    register: {
        enumerable: pt,
        value: (...i) => {
            lt.add(...i), Rs();
...
function Pl(i, t, e, s) {
    const n = Sl(i.options.borderRadius),
        o = (e - t) / 2,
        a = Math.min(o, (s * t) / 2),
        r = (l) => {
...
function pi(i, t, e, s, n, o) {
    ...
    const p = Math.max(0.001, g * d - e / N) / d,
        m = (g - p) / 2,
        b = l + m + f,
        x = n - m - f,
        {
        ...
        q = x - M / A;
    if ((i.beginPath(), o)) {
        if ((i.arc(a, r, d, k, T), v > 0)) {
            const W = zt(P, T, a, r);
            i.arc(W.x, W.y, v, T, x + V);
        }
        const C = zt(A, x, a, r);
        if ((i.lineTo(C.x, C.y), M > 0)) {
            const W = zt(A, q, a, r);
        ...
        if ((i.lineTo($.x, $.y), y > 0)) {
            const W = zt(w, k, a, r);
            i.arc(W.x, W.y, y, b - V, k);
        }
    } else {
        i.moveTo(a, r);
        const C = Math.cos(k) * d + a,
            $ = Math.sin(k) * d + r;
        i.lineTo(C, $);
        const W = Math.cos(T) * d + a,
            Mt = Math.sin(T) * d + r;
        i.lineTo(W, Mt);
    }
    i.closePath();
...
function Dl(i, t, e) {
    ...
    for (
        ...
        i.stroke();
    for (i.beginPath(), i.arc(s, n, l, o, o + I), h = 0; h < r; ++h) i.stroke();
}
...
class zi extends ot {
    ...
    inRange(t, e, s) {
        const n = this.getProps(["x", "y"], s),
            { angle: o, distance: a } = an(n, { x: t, y: e }),
            {
                startAngle: r,
                endAngle: l,
                innerRadius: c,
    ...
    draw(t) {
        ...
        if (n) {
            ...
            t.translate(Math.cos(c) * r, Math.sin(c) * r),
                this.circumference >= N && (r = n);
        }
        (t.fillStyle = e.backgroundColor), (t.strokeStyle = e.borderColor);
        const l = Cl(t, this, r, o, a);
        Ol(t, this, r, o, l, a), t.restore();
    }
}
zi.id = "arc";
zi.defaults = {
...
function Bl(i, t, e, s) {
    zl && !t.options.segment ? Fl(i, t, e, s) : Il(i, t, e, s);
}
class wt extends ot {
    constructor(t) {
        super(),
    ...
    get segments() {
        return (
            this._segments || (this._segments = Na(this, this.options.segment))
        );
    }
    first() {
    ...
    interpolate(t, e) {
        const s = this.options,
            n = t[e],
            o = this.points,
            a = En(this, { property: e, start: n, end: n });
        if (!a.length) return;
        const r = [],
            l = Rl(s);
        let c, h;
    ...
    draw(t, e, s, n) {
        ...
        (this.points || []).length &&
            o.borderWidth &&
            (t.save(), Bl(t, this, s, n), t.restore()),
            this.animated &&
...
function $l(i, t, e) {
    ...
    for (const r of s) {
        ...
        const d = En(t, h);
        for (const u of d) {
            const f = bi(e, o[u.start], o[u.end], u.loop),
                g = An(r, n, f);
            for (const p of g)
                a.push({
                    source: p,
...
function Jl(i) {
    const { scale: t, index: e, line: s } = i,
        ...
        a = s.points,
        r = Ql(t, e);
    r.push(Zn({ x: null, y: t.bottom }, s));
    for (let l = 0; l < o.length; l++) {
        const c = o[l];
        for (let h = c.start; h <= c.end; h++) tc(n, a[h], r);
    }
    return new wt({ points: n, options: {} });
}
function Ql(i, t) {
    const e = [],
...
function tc(i, t, e) {
    ...
    for (let n = 0; n < e.length; n++) {
        const o = e[n],
            { first: a, last: r, point: l } = ec(o, t, "x");
        if (!(!l || (a && r))) {
            if (a) s.unshift(l);
...
function ic(i) {
    ...
    if (H(e)) return sc(t, e);
    if (e === "stack") return Jl(i);
    if (e === "shape") return !0;
    const n = nc(i);
    return n instanceof Jn ? n : Zn(n, s);
}
function sc(i, t) {
...
function nc(i) {
    return (i.scale || {}).getPointPositionForValue ? ac(i) : oc(i);
}
function oc(i) {
...
function rc(i, t) {
    ...
    i.save(),
        l === "x" &&
            o !== n &&
            (Bs(i, s, a.top),
            Ns(i, { line: e, target: s, color: n, scale: r, property: l }),
            i.restore(),
            i.save(),
            Bs(i, s, a.bottom)),
        Ns(i, { line: e, target: s, color: o, scale: r, property: l }),
        i.restore();
}
function Bs(i, t, e) {
...
function Ns(i, t) {
    ...
    for (const { source: l, target: c, start: h, end: d } of r) {
        const { style: { backgroundColor: u = o } = {} } = l,
            f = s !== !0;
        i.save(), (i.fillStyle = u), lc(i, a, f && bi(n, h, d)), i.beginPath();
...
var cc = {
    ...
    afterDatasetsUpdate(i, t, e) {
        ...
        for (a = 0; a < s; ++a)
            (l = n[a]),
                !(!l || l.fill === !1) && (l.fill = Xl(n, a, e.propagate));
    },
    beforeDraw(i, t, e) {
...
class Hs extends ot {
    ...
    fit() {
        ...
        const s = t.labels,
            ...
            { boxWidth: r, itemHeight: l } = Ws(s, o);
        let c, h;
        (e.font = n.string),
            this.isHorizontal()
    ...
    _draw() {
        const { options: t, columnSizes: e, lineWidths: s, ctx: n } = this,
            { align: o, labels: a } = t,
            r = E.color,
            l = Bt(t.rtl, this.left, this.width),
            c = Y(a.font),
            { color: h, padding: d } = a,
            u = c.size,
            f = u / 2;
        ...
        this.drawTitle(),
            ...
            (n.lineWidth = 0.5),
            (n.font = c.string);
        const { boxWidth: p, boxHeight: m, itemHeight: b } = Ws(a, u),
            x = function (w, P, k) {
                if (isNaN(p) || p <= 0 || isNaN(m) || m < 0) return;
                n.save();
                const T = D(k.lineWidth, 1);
                if (
                    ((n.fillStyle = D(k.fillStyle, r)),
                    (n.lineCap = D(k.lineCap, "butt")),
                    (n.lineDashOffset = D(k.lineDashOffset, 0)),
                    (n.lineJoin = D(k.lineJoin, "miter")),
                    (n.lineWidth = T),
                    (n.strokeStyle = D(k.strokeStyle, r)),
                    ...
                    const L = {
                        ...
                        A = l.xPlus(w, p / 2),
                        j = P + f;
                    xn(n, L, A, j, a.pointStyleWidth && p);
                } else {
                    const L = P + Math.max((u - m) / 2, 0),
                        A = l.leftForLtr(w, p),
                        j = Ot(k.borderRadius);
                    n.beginPath(),
                        Object.values(j).some((q) => q !== 0)
                            ? oe(n, { x: A, y: L, w: p, h: m, radius: j })
                            : n.rect(A, L, p, m),
                        n.fill(),
                        T !== 0 && n.stroke();
                }
        ...
        this.legendItems.forEach((w, P) => {
            ...
            const k = n.measureText(w.text).width,
                T = l.textAlign(w.textAlign || (w.textAlign = a.textAlign)),
                L = p + f + k;
            let A = g.x,
                j = g.y;
            ...
            const q = l.x(A);
            x(q, j, w),
                (A = Co(T, A + p + f, v ? A + L : this.right, t.rtl)),
                y(l.x(A), j, w),
                v ? (g.x += L + d) : (g.y += M);
        }),
    ...
    drawTitle() {
        const t = this.options,
            ...
            n = K(e.padding);
        if (!e.display) return;
        const o = Bt(t.rtl, this.left, this.width),
            a = this.ctx,
            r = e.position,
            l = s.size / 2,
            c = n.top + l;
    ...
    _getLegendItemAt(t, e) {
        ...
        if (gt(t, this.left, this.right) && gt(e, this.top, this.bottom)) {
            for (o = this.legendHitBoxes, s = 0; s < o.length; ++s)
                if (
                    ((n = o[s]),
                    gt(t, n.left, n.left + n.width) &&
                        gt(e, n.top, n.top + n.height))
                )
...
var uc = {
    ...
    start(i, t, e) {
        ...
        et.configure(i, s, e), et.addBox(i, s);
    },
    stop(i) {
        et.removeBox(i, i.legend), delete i.legend;
    },
    beforeUpdate(i, t, e) {
        const s = i.legend;
        et.configure(i, s, e), (s.options = e);
    },
    afterUpdate(i) {
        const t = i.legend;
    ...
    _drawArgs(t) {
        ...
        return (
            this.isHorizontal()
                ...
                : (a.position === "left"
                      ? ((h = s + t), (d = X(r, n, e)), (l = N * -0.5))
                      : ((h = o - t), (d = X(r, e, n)), (l = N * 0.5)),
                  (c = n - e)),
...
function fc(i, t) {
    ...
    et.configure(i, e, t), et.addBox(i, e), (i.titleBlock = e);
}
var gc = {
    id: "title",
    _element: Qn,
    ...
    stop(i) {
        ...
        et.removeBox(i, t), delete i.titleBlock;
    },
    beforeUpdate(i, t, e) {
...
function js(i, t) {
    ...
    return (
        ...
        F(i.title, y),
        (e.font = l.string),
        F(i.beforeBody.concat(i.afterBody), y),
...
function $s(i, t, e) {
    const s = e.yAlign || t.yAlign || mc(i, e);
...
class xi extends ot {
    ...
    getBeforeBody(t, e) {
        return Xs(e.callbacks.beforeBody.apply(this, [t]));
    }
    getBody(t, e) {
        const { callbacks: s } = e,
            n = [];
        return (
            F(t, (o) => {
                const a = { before: [], lines: [], after: [] },
                    r = Us(s, o);
                at(a.before, ut(r.beforeLabel.call(this, o))),
                    at(a.lines, r.label.call(this, o)),
                    at(a.after, ut(r.afterLabel.call(this, o))),
                    n.push(a);
            }),
            n
        );
    ...
    getAfterBody(t, e) {
        return Xs(e.callbacks.afterBody.apply(this, [t]));
    }
    getFooter(t, e) {
        const { callbacks: s } = e,
    ...
    _createItems(t) {
        ...
        let r = [],
            l,
            c;
        for (l = 0, c = e.length; l < c; ++l) r.push(pc(this.chart, e[l]));
        return (
    ...
    _drawColorBox(t, e, s, n, o) {
        ...
        if (o.usePointStyle) {
            ...
            Object.values(x).some((y) => y !== 0)
                ? (t.beginPath(),
                  (t.fillStyle = o.multiKeyBackground),
                  oe(t, { x: m, y: p, w: c, h: l, radius: x }),
                  t.fill(),
                  t.stroke(),
                  (t.fillStyle = a.backgroundColor),
                  t.beginPath(),
                  oe(t, { x: b, y: p + 1, w: c - 2, h: l - 2, radius: x }),
                  t.fill())
                : ((t.fillStyle = o.multiKeyBackground),
                  t.fillRect(m, p, c, l),
    ...
    drawBody(t, e, s) {
        ...
        let u = d.lineHeight,
            f = 0;
        const g = Bt(s.rtl, this.x, this.width),
            p = function (P) {
...
function kc(i, t, e, s) {
    const n = i.indexOf(t);
    if (n === -1) return Mc(i, t, e, s);
    const o = i.lastIndexOf(t);
    return n !== o ? e : n;
}
const Sc = (i, t) => (i === null ? null : U(Math.round(i), 0, t));
class Re extends Lt {
    constructor(t) {
        super(t),
    ...
    parse(t, e) {
        ...
        return (
            (e =
                isFinite(e) && s[e] === t
                    ? e
                    : kc(s, t, D(e, t), this._addedLabels)),
            Sc(e, s.length - 1)
        );
    }
    determineDataLimits() {
...
Re.id = "category";
Re.defaults = { ticks: { callback: Re.prototype.getLabelForValue } };
function Pc(i, t) {
    const e = [],
        {
            bounds: n,
    ...
    (k = Math.ceil(m / _) - Math.floor(p / _)),
        ...
        n === "ticks"
            ? ((w = Math.floor(p / _) * _), (P = Math.ceil(m / _) * _))
            : ((w = p), (P = m)),
        b && x && o && yo((r - a) / o, _ / 1e3)
            ? ((k = Math.round(Math.min((r - a) / _, h))),
              (_ = (r - a) / k),
              (w = a),
              (P = r))
            : y
            ? ((w = b ? a : w), (P = x ? r : P), (k = c - 1), (_ = (P - w) / k))
            : ((k = (P - w) / _),
              Jt(k, Math.round(k), _ / 1e3)
                  ? (k = Math.round(k))
                  : (k = Math.ceil(k)));
    const T = Math.max(Xi(_), Xi(w));
    (M = Math.pow(10, R(l) ? T : l)),
        (w = Math.round(w * M) / M),
        (P = Math.round(P * M) / M);
    let L = 0;
    for (
        ...
        (u && w !== a
            ? (e.push({ value: a }),
              w < a && L++,
              Jt(Math.round((w + L * _) * M) / M, a, Ks(a, v, i)) && L++)
            : w < a && L++);
        L < k;
        ++L
    )
        e.push({ value: Math.round((w + L * _) * M) / M });
    return (
        x && u && P !== r
            ? e.length && Jt(e[e.length - 1].value, r, Ks(r, v, i))
...
class Fe extends Lt {
    ...
    buildTicks() {
        ...
        const n = {
            ...
            a = Pc(n, o);
        return (
            t.bounds === "ticks" && on(a, this, "value"),
            t.reverse
...
Vi.id = "linear";
Vi.defaults = { ticks: { callback: Ve.formatters.numeric } };
function qs(i) {
...
function Cc(i, t) {
    ...
    do
        n.push({ value: o, major: qs(o) }),
            ++r,
            r === 10 && ((r = 1), ++a, (l = a >= 0 ? 1 : l)),
            (o = Math.round(r * Math.pow(10, a) * l) / l);
    while (a < e || (a === e && r < s));
    const c = Q(i.max, o);
    return n.push({ value: c, major: qs(o) }), n;
}
class to extends Lt {
    constructor(t) {
        super(t),
...
to.id = "logarithmic";
to.defaults = {
    ticks: { callback: Ve.formatters.logarithmic, major: { enabled: !0 } },
};
function _i(i) {
    const t = i.ticks;
    if (t.display && i.display) {
        const e = K(t.backdropPadding);
        return D(t.font && t.font.size, E.font.size) + e.height;
    }
    return 0;
}
function Dc(i, t, e) {
    return (
        (e = B(e) ? e : [e]),
        { w: Jo(i, t.string, e), h: e.length * t.lineHeight }
    );
}
...
function Oc(i) {
    const t = {
        ...
        r = a.centerPointLabels ? N / o : 0;
    for (let l = 0; l < o; l++) {
        const c = a.setContext(i.getPointLabelContext(l));
        n[l] = c.padding;
        const h = i.getPointPosition(l, i.drawingArea + n[l], r),
            d = Y(c.font),
            u = Dc(i.ctx, d, i._pointLabels[l]);
        s[l] = u;
        const f = Z(i.getIndexAngle(l) + r),
            g = Math.round(vi(f)),
            p = Gs(g, h.x, u.w, 0, 180),
            m = Gs(g, h.y, u.h, 90, 270);
        Ac(e, t, f, p, m);
    }
...
function Ec(i, t, e) {
    const s = [],
        ...
        a = _i(o) / 2,
        r = i.drawingArea,
        l = o.pointLabels.centerPointLabels ? N / n : 0;
    for (let c = 0; c < n; c++) {
        const h = i.getPointPosition(c, r + a + e[c], l),
            d = Math.round(vi(Z(h.angle + V))),
            u = t[c],
            f = Rc(h.y, u.h, d),
            g = Tc(d),
            p = Lc(h.x, u.w, g);
    ...
    for (let n = t - 1; n >= 0; n--) {
        ...
        if (!R(g)) {
            ...
            Object.values(p).some((_) => _ !== 0)
                ? (e.beginPath(),
                  oe(e, { x: b, y: x, w: y, h: v, radius: p }),
                  e.fill())
                : e.fillRect(b, x, y, v);
        }
        Tt(e, i._pointLabels[n], r, l + a.lineHeight / 2, a, {
            color: o.color,
            textAlign: c,
            textBaseline: "middle",
        });
...
class He extends Fe {
    ...
    setDimensions() {
        const t = (this._padding = K(_i(this.options) / 2)),
    ...
    drawGrid() {
        ...
        let a, r, l;
        if (
            (e.pointLabels.display && Fc(this, o),
            n.display &&
    ...
    drawLabels() {
        ...
        t.save(),
            ...
            this.ticks.forEach((r, l) => {
                ...
                Tt(t, r.label, 0, -o, h, { color: c.color });
            }),
            t.restore();
    }
    drawTitle() {}
...
He.descriptors = { angleLines: { _fallback: "grid" } };
const je = {
...
function Zs(i, t) {
    ...
    return (
        ...
        H(a) || (a = typeof s == "string" ? e.parse(a, s) : e.parse(a)),
        a === null
            ? null
            : (n &&
                  (a =
...
function Nc(i, t, e, s, n) {
    for (let o = G.length - 1; o >= G.indexOf(e); o--) {
        const a = G[o];
        if (je[a].common && i._adapter.diff(n, s, a) >= t - 1) return a;
    }
    return G[e ? G.indexOf(e) : 0];
}
function Vc(i) {
    for (let t = G.indexOf(i) + 1, e = G.length; t < e; ++t)
        if (je[G[t]].common) return G[t];
}
function Qs(i, t, e) {
    if (!e) i[t] = !0;
    else if (e.length) {
...
class $e extends Lt {
    ...
    init(t, e) {
        const s = t.time || (t.time = {}),
            n = (this._adapter = new Rr._date(t.adapters.date));
        n.init(e),
        ...
        return (
            (this._unit =
                ...
                (s.autoSkip
                    ...
                    : Nc(this, r.length, e.minUnit, this.min, this.max))),
            (this._majorUnit =
    ...
    _generate() {
        const t = this._adapter,
            ...
            n = this.options,
            o = n.time,
            a = o.unit || Js(o.minUnit, e, s, this._getLabelCapacity(e)),
            r = D(o.stepSize, 1),
    ...
    getLabelTimestamps() {
        ...
        for (e = 0, s = n.length; e < s; ++e) t.push(Zs(this, n[e]));
...
function ke(i, t, e) {
    ...
    e
        ? (t >= i[s].pos &&
              t <= i[n].pos &&
              ({ lo: s, hi: n } = Dt(i, "pos", t)),
          ({ pos: o, time: r } = i[s]),
          ({ pos: a, time: l } = i[n]))
        : (t >= i[s].time &&
              t <= i[n].time &&
              ({ lo: s, hi: n } = Dt(i, "time", t)),
          ({ time: o, pos: r } = i[s]),
          ({ time: a, pos: l } = i[n]));
    const c = a - o;
...
function oo(i, t) {
    let e = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : so;
    const s = [];
    i.datasets = t.map((n) => {
...
function jc(i) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : so;
    const e = { labels: [], datasets: [] };
    return no(e, i.labels), oo(e, i.datasets, t), e;
}
function $c(i, t) {
    let {
        height: e = 150,
    ...
    const f = rt.exports.useRef(null),
        g = rt.exports.useRef(),
        p = () => {
            !f.current ||
                ((g.current = new de(f.current, {
                    type: a,
                    data: jc(r, o),
                    options: l && { ...l },
                    plugins: c,
        ...
        m = () => {
            en(t, null), g.current && (g.current.destroy(), (g.current = null));
        };
    return (
        rt.exports.useEffect(() => {
            !n && g.current && l && Hc(g.current, l);
        }, [n, l]),
        rt.exports.useEffect(() => {
            !n && g.current && no(g.current.config.data, r.labels);
        }, [n, r.labels]),
        rt.exports.useEffect(() => {
            !n &&
                g.current &&
                r.datasets &&
                oo(g.current.config.data, r.datasets, o);
        }, [n, r.datasets]),
        rt.exports.useEffect(() => {
            !g.current || (n ? (m(), setTimeout(p)) : g.current.update(d));
        }, [n, l, r.labels, r.datasets, d]),
        rt.exports.useEffect(() => {
            !g.current || (m(), setTimeout(p));
        }, [a]),
        rt.exports.useEffect(() => (p(), () => m()), []),
        S.createElement(
            "canvas",
            Object.assign({ ref: f, role: "img", height: e, width: s }, u),
            h
        )
    );
}
const Yc = rt.exports.forwardRef($c);
function Xc(i, t) {
    return (
        de.register(t),
        rt.exports.forwardRef((e, s) =>
            S.createElement(Yc, Object.assign({}, e, { ref: s, type: i }))
        )
    );
}
const Uc = Xc("line", Ne);
de.register(Re, Vi, We, wt, gc, wc, cc, uc);
function Gc() {
    const { auth: i, count: t, chart: e } = ao().props,
        s = {
            responsive: !0,
            plugins: {
                legend: { position: "top" },
    ...
    return S.createElement(
        ...
        S.createElement(
            ro,
            null,
            S.createElement("title", null, "Dashboard - Egxa Store")
        ),
        S.createElement(
            lo,
            null,
            S.createElement(
                ...
                S.createElement(
                    ...
                    S.createElement(
                        ...
                        {
                            className:
                                "alert alert-success border-0 shadow-sm mb-0",
                        },
                        "Selamat Datang, ",
                        S.createElement("strong", null, i.user.name)
                    )
                )
            ),
            Wi(["dashboard.statistics"]) &&
                S.createElement(
                    "div",
                    { className: "row mt-2" },
                    S.createElement(
                        ...
                        S.createElement(
                            ...
                            S.createElement(
                                ...
                                S.createElement(
                                    ...
                                    S.createElement("i", {
                                        className:
                                            "fas fa-circle-notch fa-spin fa-2x text-white",
                                    })
                                ),
                                S.createElement(
                                    "div",
                    ...
                    S.createElement(
                        ...
                        S.createElement(
                            ...
                            {
                                className:
                                    "card border-0 rounded shadow-sm overflow-hidden",
                            },
                            S.createElement(
                                "div",
                                {
                                ...
                                S.createElement(
                                    ...
                                    S.createElement("i", {
                                        className:
                                            "fas fa-check-circle fa-2x text-white",
                                    })
                                ),
                                S.createElement(
                                    "div",
                        ...
                        S.createElement(
                            ...
                            S.createElement(
                                ...
                                S.createElement(
                                    ...
                                    S.createElement("i", {
                                        className:
                                            "fas fa-exclamation-triangle fa-2x text-white",
                                    })
                                ),
                                S.createElement(
                                    "div",
                        ...
                        S.createElement(
                            ...
                            S.createElement(
                                ...
                                S.createElement(
                                    ...
                                    S.createElement(
                                        "div",
                                        { className: "text-value text-danger" },
                                        t.cancelled
                                    ),
                                    S.createElement(
                                        "div",
                ...
                S.createElement(
                    ...
                    S.createElement(
                        ...
                        S.createElement(
                            ...
                            {
                                className:
                                    "card border-0 border-top-success shadow-sm",
                            },
                            S.createElement(
                                "div",
                            ...
                            S.createElement(
                                "div",
                                { className: "card-body" },
                                S.createElement(Uc, { options: s, data: n })
                            )
                        )
                    )
                )
